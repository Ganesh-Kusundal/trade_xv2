...
This keeps the dependency direction clean:
  application/ → tradex.runtime/ → brokers/dhan|upstox/ → domain/

Usage at composition root (bootstrap)::

    from tradex.runtime.infrastructure import BrokerInfrastructure, build_infrastructure
...
async def build_infrastructure(
    ...
    *,
    ...
    policy
        ...
        ``tradex.runtime.policy`` or construct your own.
    bundles
