...
def test_instrument_key_resolution():
    ...
    all_pass = True
    for symbol, exchange, expected_format, should_work in test_cases:
    ...
    for symbol, exchange, description in test_cases:
        ...
        try:
            ...
            if len(df) > 0:
                ...
                console.print(f"  ⚠ No data returned (market may be closed)")
...
def test_edge_cases():
    ...
    if ' ' in key:
        console.print(f"  ⚠ Warning: Key contains space (expected for fallback)")
