...
See [`docs/constitution/05-bounded-contexts.md`](../constitution/05-bounded-contexts.md) for broker bounded context.

## Three equivalent interfaces (single core)

Every capability delegates to [`src/brokers/services/`](../../src/brokers/services/) — one code path:
