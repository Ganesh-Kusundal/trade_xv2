...
Cron setup (run daily at 6 PM IST, after market close at 3:30 PM):
    ...
    TZ=Asia/Kolkata
    0 18 * * 1-5 cd /Users/apple/Downloads/Trade_XV2 && /Users/apple/Downloads/Trade_XV2/venv/bin/python -m cli.main options-sync >> /Users/apple/Downloads/Trade_XV2/logs/options-sync.log 2>&1
