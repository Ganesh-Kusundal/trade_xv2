...
_NSE_HOLIDAYS: set[date] = {
    ...
    date(2024, 10, 2), date(2024, 10, 12), date(2024, 11, 1),
    date(2024, 11, 15), date(2024, 12, 25),
    # 2025
    date(2025, 1, 26), date(2025, 2, 26), date(2025, 3, 14),
    date(2025, 3, 31), date(2025, 4, 10), date(2025, 4, 14),
    date(2025, 4, 18), date(2025, 5, 1), date(2025, 6, 27),
    date(2025, 8, 15), date(2025, 10, 2), date(2025, 10, 21),
    date(2025, 11, 5), date(2025, 12, 25),
    # 2026
    date(2026, 1, 26), date(2026, 3, 6), date(2026, 3, 27),
