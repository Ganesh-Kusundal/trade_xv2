...
ALLOWLIST = {
    ...
    "brokers/providers/paper/paper_gateway.py",
    "brokers/providers/paper/segment_mapper.py",
    "brokers/providers/paper/__init__.py",
    # Broker dhan layer (segment mappings and validation)
    "brokers/providers/dhan/segments.py",
    "brokers/providers/dhan/wire.py",
    "brokers/providers/dhan/loader.py",
    "brokers/providers/dhan/extended_data.py",
    "brokers/providers/dhan/portfolio/",
    "brokers/providers/dhan/data/",
    # Broker upstox adapter layer
    "brokers/providers/upstox/instrument_adapter.py",
    "brokers/providers/upstox/adapters/",
    "brokers/providers/upstox/market_data/futures.py",
    "brokers/providers/upstox/market_data/market_status.py",
    "brokers/providers/upstox/instruments/",
    "brokers/providers/upstox/mappers/",
    ...
    "brokers/session/",
    "brokers/providers/dhan/websocket/",
    "brokers/providers/dhan/identity/",
    "brokers/providers/dhan/extensions/",
    "brokers/providers/dhan/streaming/",
    ...
    "brokers/providers/dhan/symbol_validator.py",
    "brokers/providers/dhan/extended_positions.py",
    "brokers/providers/dhan/extended.py",
    "_test_",
    "_spec_",
}
