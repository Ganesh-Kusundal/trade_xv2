...
def test_place_conditional_trigger_price_above(fake_client, resolver):
    ...
    fake_client.set_response("POST", "/alerts/orders", {
        "data": {"alertId": "CT123456"}
    })
...
def test_modify_conditional_trigger(fake_client, resolver):
    ...
    fake_client.set_response("PUT", "/alerts/orders/CT123456", {
        "data": {
            "alertId": "CT123456",
            "alertStatus": "ACTIVE",
...
def test_delete_conditional_trigger(fake_client, resolver):
    ...
    fake_client.set_response("DELETE", "/alerts/orders/CT123456", {
        "status": "success"
    })
    adapter = ConditionalTriggersAdapter(fake_client, resolver)
...
def test_get_conditional_trigger_by_id(fake_client, resolver):
    ...
    fake_client.set_response("GET", "/alerts/orders/CT123456", {
        "data": {
            "alertId": "CT123456",
            "alertStatus": "ACTIVE",
            "comparisonType": "PRICE_WITH_VALUE",
...
def test_get_all_conditional_triggers(fake_client, resolver):
    ...
    fake_client.set_response("GET", "/alerts/orders", {
        "data": [
            {
                "alertId": "CT001",
                "alertStatus": "ACTIVE",
