...
class TestErrorPaths:
    ...
    def test_quote_invalid_symbol(self, gateway: DhanBrokerGateway):
    ...
    def test_ltp_invalid_symbol(self, gateway: DhanBrokerGateway):
    ...
    def test_depth_invalid_symbol(self, gateway: DhanBrokerGateway):
    ...
    def test_history_invalid_symbol(self, gateway: DhanBrokerGateway):
    ...
    def test_history_invalid_timeframe(self, gateway: DhanBrokerGateway):
    ...
    def test_option_chain_invalid_underlying(self, gateway: DhanBrokerGateway):
    ...
    def test_future_chain_invalid_underlying(self, gateway: DhanBrokerGateway):
    ...
    def test_search_empty_query(self, gateway: DhanBrokerGateway):
    ...
    def test_batch_ltp_empty_symbols(self, gateway: DhanBrokerGateway):
        """ltp_batch() with empty list should return empty dict."""
        result = gateway.ltp_batch([], "NSE")
        assert isinstance(result, dict)
        assert len(result) == 0

    def test_batch_quote_empty_symbols(self, gateway: DhanBrokerGateway):
        """quote_batch() with empty list should return empty dict."""
        result = gateway.quote_batch([], "NSE")
        assert isinstance(result, dict)
        assert len(result) == 0

    def test_place_order_missing_price_for_limit(self, gateway: DhanBrokerGateway):
