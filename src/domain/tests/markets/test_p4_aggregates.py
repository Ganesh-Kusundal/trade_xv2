...
in Phase 4. Their behavior is now tested via:
  - ``src/domain/tests/test_instrument.py`` (Instrument/OptionChain/subscribe)
  - ``src/domain/tests/test_execution.py`` (Execution aggregate)
  - ``src/domain/tests/test_portfolio.py`` (Portfolio PnL/exposure/concentration)
  - ``src/domain/tests/test_risk_policy.py`` (risk policies)
"""
