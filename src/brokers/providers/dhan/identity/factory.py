...
from brokers.providers.dhan.config.settings import DhanConnectionSettings, DhanSettingsLoader
...
class BrokerFactory(BrokerProviderFactory):
    ...
    def _create_auth(
        ...
        * Persist store + env atomically on mint.
        ...
        def _generate_token() -> str | None:
            ...
            # ``brokers.providers.dhan.identity.factory._generate_totp_token``.
        ...
        try:
            ...
            from brokers.providers.dhan.exceptions import ConfigurationError
    ...
    def _create_http_client(
        ...
        from brokers.providers.dhan.resilience import create_circuit_breakers, create_rate_limiter
    ...
    def _setup_token_refresh_scheduler(
        ...
        from brokers.providers.dhan.auth.token_scheduler import TokenRefreshScheduler
...
def _generate_totp_token(settings: DhanConnectionSettings | None = None) -> str | None:
    ...
    # ``brokers.providers.dhan.auth.totp_client.DhanTotpClient``.
    from brokers.providers.dhan.auth.totp_client import DhanTotpClient
