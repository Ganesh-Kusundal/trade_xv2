...
Anything in ``brokers/providers/dhan/**`` that builds an outgoing Dhan HTTP payload
**must** import from this module — *not* from ``brokers/providers/dhan/resolver.py``
...
* :class:`DhanIdentityError` — raised on resolution failure (re-exported
  from :mod:`brokers.providers.dhan.exceptions`).
    ...
    def resolve_ref(
        ...
        *,
        ...
        exchange:
            ...
            via :data:`brokers.providers.dhan.segments.SEGMENT_TO_EXCHANGE`.
        expected_segment:
