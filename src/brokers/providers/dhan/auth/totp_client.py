...
if TYPE_CHECKING:
    from brokers.providers.dhan.config.settings import DhanConnectionSettings
...
class DhanTotpClient:
    ...
    def _resolve_credentials(self) -> tuple[str | None, str | None, str, str]:
        ...
        from brokers.providers.dhan.config.settings import _GENERATE_TOKEN_URL

        client_id = os.environ.get("DHAN_CLIENT_ID", "")
        return pin, totp_secret, _GENERATE_TOKEN_URL, client_id


from brokers.providers.dhan.auth.secret_utils import read_secret as _read_secret
