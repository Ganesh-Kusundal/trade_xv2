...
Extracted from :class:`brokers.providers.dhan.execution.orders.OrdersAdapter` god class.
Owns:
...
from brokers.providers.dhan.execution.order_validator import OrderValidator
...
# Re-exported here so existing `from brokers.providers.dhan.execution.order_placement
# import IdempotencyCache` call sites (and the two backward-compat shims at
# brokers/providers/dhan/orders.py and brokers/providers/dhan/order_placement.py) keep working.
