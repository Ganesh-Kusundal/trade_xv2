...
The :class:`brokers.providers.dhan.resolver.SymbolResolver` is loaded once at
...
that re-runs :meth:`brokers.providers.dhan.connection.DhanConnection.load_instruments`
