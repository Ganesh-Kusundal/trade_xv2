...
Extracted from the former monolithic ``brokers/providers/dhan/websocket.py`` (Task 5.1).
...
from brokers.providers.dhan.segments import to_sdk_int
...
# ``import brokers.providers.dhan.wire`` works even when the SDK is not installed.
# ---------------------------------------------------------------------------


def _sdk_market_feed_class() -> type:
    """Lazy import so ``import brokers.providers.dhan.wire`` does not require dhanhq at import time."""
