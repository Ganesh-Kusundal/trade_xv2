...
from brokers.providers.dhan.websocket._helpers import _DhanContext, _sdk_market_feed_class
...
class MarketFeedConnection:
    ...
    def _emit_reconnect_metric(self) -> None:
        try:
            from brokers.providers.dhan.resilience.metrics import dhan_ws_reconnect_total
