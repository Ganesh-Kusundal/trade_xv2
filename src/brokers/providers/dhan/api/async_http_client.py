...
by :class:`~brokers.providers.dhan.api.http_client.DhanHttpClient`.  All retry back-offs and
...
Usage::
    ...
    from brokers.providers.dhan.api.async_http_client import DhanAsyncHttpClient
...
from brokers.providers.dhan.api.http_client import _match_rate_limit as _match_static_rate_limit
