"""UpstoxStreaming — WebSocket connections, tick parsing, stream handles.
...
class UpstoxStreaming:
    ...
    Example::
        ...
        gw = UpstoxStreaming(broker, stream_manager, resolve_key_fn)
    ...
    def stream_depth(
        ...
        *,
        ...
        depth_type: str | None = None,  # DEPTH_5, DEPTH_30 — deprecated, use levels
    ) -> Any:
        ...
        *levels* is the canonical entry point (mirrors Dhan's
        ...
        if levels != 5 or depth_type is None:
            # levels was explicitly set (or depth_type not provided) — resolve from levels
            if levels is not None:
                ...
                depth_type = "DEPTH_5"
        # else: depth_type was explicitly provided and levels is at default — use depth_type as-is
