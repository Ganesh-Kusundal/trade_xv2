"""``python -m brokers.providers.upstox.auth.login`` — interactive Upstox OAuth flow.
...
Usage::
    ...
    UPSTOX_CLIENT_ID=xxx UPSTOX_CLIENT_SECRET=yyy \\
        python -m brokers.providers.upstox.auth.login
...
logger = logging.getLogger("brokers.providers.upstox.auth.login")
