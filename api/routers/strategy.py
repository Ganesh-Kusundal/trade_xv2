...
from api.schemas import StrategySignalsResponse, StrategySignal
...
async def get_strategy_signals(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=f"Strategy signals fetch failed: {str(exc)}",
        )
...
async def get_strategy_candidates(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Strategy candidates fetch failed: {str(exc)}",
        )
