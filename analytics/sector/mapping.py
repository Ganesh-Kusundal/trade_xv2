...
DEFAULT_SECTOR_MAP: dict[str, str] = {
    ...
    "LTTS": "IT", "PERSISTENT": "IT", "COFORGE": "IT", "MPHASIS": "IT", "KPITTECH": "IT",
    "BSOFT": "IT", "CYIENT": "IT", "ZENSARTECH": "IT", "TATAELXSI": "IT", "HAPPSTMNDS": "IT",
    "INTELLECT": "IT", "CDSL": "IT",
    # Finance (includes Banking)
    "HDFCBANK": "Finance", "ICICIBANK": "Finance", "KOTAKBANK": "Finance", "AXISBANK": "Finance",
    "SBIN": "Finance", "INDUSINDBK": "Finance", "BANDHANBNK": "Finance", "FEDERALBNK": "Finance",
    "IDFCFIRSTB": "Finance", "PNB": "Finance", "BANKBARODA": "Finance", "BANKINDIA": "Finance",
    "UNIONBANK": "Finance", "CANBK": "Finance", "AUBANK": "Finance", "KARURVYSYA": "Finance",
    "BAJFINANCE": "Finance", "BAJAJFINSV": "Finance", "SBILIFE": "Finance", "HDFCLIFE": "Finance",
    "ICICIPRULI": "Finance", "MUTHOOTFIN": "Finance", "MANAPPURAM": "Finance", "CHOLAFIN": "Finance",
    "LICHSGFIN": "Finance", "SBICARD": "Finance", "SHRIRAMFIN": "Finance", "HDFCAMC": "Finance",
    # Oil & Gas
    ...
    "LT": "Infrastructure", "ADANIENT": "Infrastructure", "ADANIPORTS": "Infrastructure", "ADANIGREEN": "Infrastructure",
    "NTPC": "Power", "POWERGRID": "Power", "TATAPOWER": "Power", "SJVN": "Power",
    "NHPC": "Power", "KEC": "Infrastructure",
    # Chemicals
    "DEEPAKNTR": "Chemicals", "ATUL": "Chemicals", "NAVINFLUOR": "Chemicals",
    "SRF": "Chemicals", "PIIND": "Chemicals", "TATACHEM": "Chemicals",
    "GSFC": "Chemicals", "GNFC": "Chemicals",
    # Cement
    "ULTRACEMCO": "Cement", "ACC": "Cement", "AMBUJACEM": "Cement",
    "DALBHARAT": "Cement", "JKCEMENT": "Cement", "SHREECEM": "Cement",
    # Consumer Durables
    ...
    "ZOMATO": "ConsumerServices", "PAYTM": "ConsumerServices", "POLICYBZR": "ConsumerServices", "NYKAA": "ConsumerServices",
    "TRENT": "ConsumerServices", "AVENUE": "ConsumerServices",
    # Capital Goods
...
class SectorMapper:
    ...
    def assign_sectors(self, df: pd.DataFrame, symbol_col: str = "symbol") -> pd.DataFrame:
        ...
        result = df.copy()
        result["sector"] = result[symbol_col].str.upper().map(self._symbol_to_sector).fillna("Unknown")
        return result
