...
def option_chain() -> pd.DataFrame:
    ...
    return pd.DataFrame([
        {"strike": 100, "option_type": "CE", "oi": 100, "change_in_oi": 20, "volume": 500, "iv": 0.20, "ltp": 5.0},
        {"strike": 110, "option_type": "CE", "oi": 80, "change_in_oi": -10, "volume": 300, "iv": 0.25, "ltp": 3.0},
        {"strike": 100, "option_type": "PE", "oi": 90, "change_in_oi": 15, "volume": 400, "iv": 0.22, "ltp": 4.0},
        {"strike": 90, "option_type": "PE", "oi": 70, "change_in_oi": -5, "volume": 200, "iv": 0.28, "ltp": 6.0},
    ])
