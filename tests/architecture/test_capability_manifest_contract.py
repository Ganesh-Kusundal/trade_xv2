...
class TestBrokerMethodPaths:
    ...
    _DHAN_ADAPTER_MODULES: ClassVar[dict[str, str]] = {
        "historical": "brokers.providers.dhan.market_data.historical",
        "market_data": "brokers.providers.dhan.market_data.market_data",
        "options": "brokers.providers.dhan.market_data.options",
        "futures": "brokers.providers.dhan.market_data.futures",
        "orders": "brokers.providers.dhan.execution.orders",
        "portfolio": "brokers.providers.dhan.portfolio.portfolio",
        "margin": "brokers.providers.dhan.portfolio.margin",
        "super_orders": "brokers.providers.dhan.execution.super_orders",
        "forever_orders": "brokers.providers.dhan.execution.forever_orders",
        "conditional_triggers": "brokers.providers.dhan.execution.conditional_triggers",
        "ledger": "brokers.providers.dhan.ledger",
        "edis": "brokers.providers.dhan.auth.edis",
        "ip_management": "brokers.providers.dhan.auth.ip_management",
        "exit_all": "brokers.providers.dhan.exit_all",
        "order_stream": "brokers.providers.dhan.websocket",
        "depth_20_feed": "brokers.providers.dhan.market_data.depth_20",
    }
