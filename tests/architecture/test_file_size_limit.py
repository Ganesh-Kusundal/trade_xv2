...
EXEMPTIONS = {
    "analytics/replay/engine.py": (560, "ReplayEngine facade — decomposed in ADR-011 Phase 3; window + event_publishing extracted"),
    "application/composer/factory.py": (430, "Composer factory — split tracked in ADR-011 backlog"),
    "application/oms/context.py": (525, "TradingContext facade — decomposed in ADR-011 Phase 3; lifecycle services extracted"),
    "application/oms/order_manager.py": (440, "OrderManager — core OMS logic; split tracked in ADR-011 backlog"),
    ...
    "brokers/dhan/data/depth_feed_base.py": (575, "Dhan depth feed — decomposed in ADR-011 Phase 3; parser delegation inlined"),
    "brokers/dhan/identity/identity.py": (441, "Dhan identity — split tracked in ADR-011 backlog"),
    "brokers/dhan/streaming/connection.py": (525, "Dhan streaming connection — split tracked in ADR-011 backlog"),
    "brokers/dhan/websocket/connection.py": (448, "Dhan websocket connection — split tracked in ADR-011 backlog"),
    "brokers/dhan/websocket/market_feed.py": (520, "Dhan market feed — split tracked in ADR-011 backlog"),
    "brokers/dhan/wire.py": (430, "Dhan gateway wire — split tracked in ADR-011 backlog"),
    ...
    "datalake/storage/catalog.py": (440, "DataCatalog — storage abstraction; split tracked in ADR-011 backlog"),
...
EXEMPTION_METADATA: dict[str, dict[str, str]] = {
    ...
    "brokers/dhan/wire.py": {"owner": "team-brokers", "due_date": "2026-08-01"},
    ...
    "datalake/storage/catalog.py": {"owner": "team-datalake", "due_date": "2026-08-01"},
