    ...
    try:
        ...
        try:
            ...
            for e in expiries[:3]:
                console.print(f"  {e}")
            results['expiries'] = {
                'status': 'PASS', 'count': len(expiries),
                'latency_ms': latency, 'nearest': expiries[0] if expiries else None,
            }
                ...
                if first_ce:
                    ...
                    if symbol:
                        ...
                        results['contract_quote'] = {
                            'status': 'PASS', 'ltp': quote.ltp,
                            'volume': quote.volume, 'latency_ms': latency,
                        }
                    else:
    ...
    try:
        ...
        try:
            ...
            for e in expiries[:3]:
                console.print(f"  {e}")
            results['expiries'] = {
                'status': 'PASS', 'count': len(expiries), 'latency_ms': latency,
