...
def test_empty_portfolio():
    ...
    assert p.gross_exposure == Decimal("0")
...
def test_single_position_pnl():
    ...
    assert p.total_pnl == Decimal("1000")
...
def test_multiple_positions_pnl():
    ...
    assert p.unrealized_pnl == Decimal("500")  # 1000 - 500
    assert p.realized_pnl == Decimal("300")    # 200 + 100
    assert p.total_pnl == Decimal("800")
...
def test_gross_exposure():
    ...
    assert p.gross_exposure == Decimal("42500")
...
def test_symbol_exposure_and_concentration():
    ...
    assert r_exposure == Decimal("25000")
