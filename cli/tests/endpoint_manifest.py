...
DESTRUCTIVE_ENDPOINTS: list[CliEndpoint] = [
    ...
    CliEndpoint("place_orders_batch", ["place-orders", "--file", "/tmp/orders.csv"], "destructive", 0, None, 30),
    CliEndpoint("bracket_order", ["bracket-order", "RELIANCE", "BUY", "1", "--target", "2500",
                                  "--stop-loss", "2400"], "destructive", 0, None, 30),
    CliEndpoint("oco_order", ["oco-order", "RELIANCE", "BUY", "1",
                              "--order1-price", "2500", "--order2-price", "2400"],
                "destructive", 0, None, 30),
    CliEndpoint("basket_order", ["basket-order", "--file", "/tmp/basket.csv"], "destructive", 0, None, 30),
    ...
    CliEndpoint("analytics_datalake_backtest", ["analytics", "datalake-backtest"],
                "destructive", 0, None, 120),
