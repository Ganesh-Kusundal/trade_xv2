...
from cli.commands import analytics as cmd_analytics
from cli.commands.analytics_backtest import run_backtest, run_paper
from cli.commands.analytics_scanner import run_rank, run_scan
from cli.commands.analytics_sector import run_breadth, run_sector, run_sector_rotation
from cli.commands.analytics_utils import (
    load_dataframe,
    parse_common_args,
    print_records,
    print_scan_result,
...
class TestScanCommand:
    ...
    def test_scan_momentum(self, csv_file, console):
        with patch("cli.commands.analytics_scanner.Analytics") as mock_analytics:
...
class TestBacktestCommand:
    ...
    def test_backtest_with_file(self, csv_file, console):
        with patch("cli.commands.analytics_backtest.BacktestEngine") as mock_engine_cls:
...
class TestPaperTradingCommand:
    ...
    def test_paper_with_file(self, csv_file, console):
        with patch("cli.commands.analytics_backtest.PaperTradingEngine") as mock_engine_cls:
            mock_engine = MagicMock()
            mock_result = MagicMock()
...
class TestBreadthCommand:
    ...
    def test_breadth_with_data(self, csv_file, console):
        ...
        with patch("cli.commands.analytics_sector.load_dataframe", return_value=df):
            run_breadth([], console)
            output = console.export_text()
...
class TestAnalyticsRouter:
    ...
    def test_analytics_stock_command(self, console):
        with patch("cli.commands.analytics.run_symbol_command") as mock_run:
